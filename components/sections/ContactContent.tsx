    ...
    <section className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          {/* Left: Office Map Box */}
          <div className="lg:w-5/12 bg-[var(--color-primary)] rounded-xl p-8 lg:p-10 text-white flex flex-col">
            ...
            <div className="bg-gray-200 w-full h-[250px] lg:h-[300px] rounded-lg overflow-hidden mb-8 relative">
              <iframe 
            ...
            <div className="mt-auto">
              <Link 
                href={data.officeCard.getDirectionsUrl}
                className="inline-block bg-[var(--color-accent)] text-white px-8 py-4 rounded text-sm font-bold uppercase tracking-wider hover:bg-opacity-90 transition shadow-md"
              >
                {data.officeCard.getDirectionsText} &rarr;
              </Link>
            </div>
          </div>
          
          {/* Right: Form Box */}
          <div className="lg:w-7/12 bg-white border border-gray-100 rounded-xl p-8 lg:p-10 shadow-sm">
            ...
            <form className="space-y-6">
              ...
              <button 
                type="button"
                className="bg-[#b38b4d] text-white px-8 py-4 rounded text-sm font-bold uppercase tracking-wider hover:bg-opacity-90 transition shadow-md flex items-center gap-2"
              >
