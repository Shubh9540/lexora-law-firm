...
export default async function OfficeLocationsPage() {
  ...
  if (!templateData || !templateData.officeLocations) {
    return <div>Data not found</div>;
  }

  const breadcrumbData = templateData.officeLocationsBreadcrumb || {
  ...
  return (
    <main className="bg-white">
      ...
      <OfficeLocationsContent data={templateData.officeLocations} />
