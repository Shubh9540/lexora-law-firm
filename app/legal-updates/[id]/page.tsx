...
export default async function LegalUpdateDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const currentUpdate = templateData.legalUpdates.items.find(
  ...
  const breadcrumbData = templateData.legalUpdateDetailBreadcrumb;
  ...
  return (
    <main className="bg-white">
      ...
      <LegalUpdateDetailContent update={currentUpdate} allUpdates={templateData.legalUpdates.items} globalUI={globalUI} />
