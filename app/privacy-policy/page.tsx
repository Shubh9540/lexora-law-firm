...
export default async function PrivacyPolicyPage() {
  ...
  if (!templateData || !sectionData?.privacyPolicy?.variants?.LexoraPrivacyPolicy1) {
    return <div>Data not found</div>;
  }

  const breadcrumbData = sectionData?.privacyPolicyBreadcrumb?.variants?.LexoraPrivacyPolicyBreadcrumb1;
  ...
  return (
    <main className="bg-white">
      ...
      <LegalPageContent data={sectionData?.privacyPolicy?.variants?.LexoraPrivacyPolicy1} />
