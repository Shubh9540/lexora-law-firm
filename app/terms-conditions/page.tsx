...
export default async function TermsConditionsPage() {
  ...
  if (!templateData || !sectionData?.termsConditions?.variants?.LexoraTermsConditions1) {
    return <div>Data not found</div>;
  }

  const breadcrumbData = sectionData?.termsConditionsBreadcrumb?.variants?.LexoraTermsConditionsBreadcrumb1;
  ...
  return (
    <main className="bg-white">
      ...
      <LegalPageContent data={sectionData?.termsConditions?.variants?.LexoraTermsConditions1} />
